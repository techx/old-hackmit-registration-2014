...
class LotteryForm(Form):
    ...
    school = TextField(validators=[InputRequired(), Length(max=120), Regexp("/^[a-zA-Z\/0-9&()–àáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]+$/u")])
